                       ...
                       size_t size)
{
        ...
        while (size > 0) {
                ...
                to_write = (PAGE_SIZE - page_off > size) ? size :
                                                           PAGE_SIZE - page_off;
        ...
        inode->size = (cur_off > inode->size) ? cur_off : inode->size;
        /* LAB 5 TODO END */
                      ...
                      size_t size)
{
        ...
        /* LAB 5 TODO BEGIN */
        size = (inode->size > size + offset) ? size : inode->size - offset;
        while (size > 0) {
                page_no = cur_off / PAGE_SIZE;
                page_off = cur_off % PAGE_SIZE;
                to_read = (PAGE_SIZE - page_off > size) ? size :
                                                          PAGE_SIZE - page_off;
                page = radix_get(&inode->data, page_no);
                if (page == NULL) {
                        break;
